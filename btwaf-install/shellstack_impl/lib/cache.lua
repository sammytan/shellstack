--[[
  ShellStack Redis 整页缓存 — 自 btwaf-ext 同步至官方安装包 shellstack_impl/lib/
  配套：shellstack_cache_config.lua、overlay/body.lua、waf.lua/init.lua/header.lua 钩子（见 SHELLSTACK_CACHE_IMPL.md）
]]
