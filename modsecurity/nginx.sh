#!/bin/bash
#不能修改该脚本, 只是用来参考宝塔的nginx安装脚本, 用于安装modsecurity的依赖库 
...
Install_LuaJIT() {
    if [ "${version}" == "1.23" ] || [ "${version}" == "1.24" ] || [ "${version}" == "tengine" ] || [ "${version}" == "1.25" ] || [ "${version}" == "1.26" ] || [ "${version}" == "1.27" ] || [ "${version}" == "1.28" ] || [ "${version}" == "openresty127" ] || [ "${version}" == "1.29" ];then
        Install_LuaJIT2
        return
    fi
...
Install_Configure() {
    ...
    if [ "$version" == "1.25" ] || [ "${version}" == "1.26" ] || [ "${version}" == "1.27" ] || [ "${version}" == "1.28" ] || [ "${version}" == "openresty127" ] || [ "${version}" == "1.29" ];then
...
EOF
    ...
    if [ "${version}" == "1.25" ] || [ "${version}" == "1.26" ] || [ "${version}" == "1.27" ] || [ "${version}" == "1.28" ] || [ "${version}" == "1.29" ];then
